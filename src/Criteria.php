...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'tenant_id', 'user_id', 'name', 'name_ci', 'token_hash', 'token_hash_key_version', 'scopes', 'status', 'last_used_at', 'expires_at', 'created_at', 'updated_at' ];
    }
    ...
    {
        $x = [ 'id', 'tenant_id', 'user_id', 'name', 'name_ci', 'token_hash_key_version', 'status', 'last_used_at', 'expires_at', 'created_at', 'updated_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\ApiKeys\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\ApiKeys\Definitions::softDeleteColumn();
