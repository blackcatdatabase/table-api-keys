...
namespace BlackCat\Database\Packages\ApiKeys;
...
use BlackCat\Database\Packages\ApiKeys\Repository\ApiKeyRepository as GeneratedRepository;
...
final class Repository
{
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof ApiKeyRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected ApiKeyRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\ApiKeys\Dto\ApiKeyDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\ApiKeys\Dto\ApiKeyDto|null { return $this->repo->getById($id, $asDto); }
