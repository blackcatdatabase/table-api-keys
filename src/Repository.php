...
use BlackCat\Database\Packages\ApiKeys\Repository\ApiKeyRepository;
...
final class Repository
{
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\ApiKeys\Dto\ApiKeyDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\ApiKeys\Dto\ApiKeyDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\ApiKeys\Dto\ApiKeyDto|null
    {
