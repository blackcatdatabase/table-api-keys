...
namespace BlackCat\Database\Packages\ApiKeys\Mapper;

use BlackCat\Database\Packages\ApiKeys\Dto\ApiKeyDto;
use BlackCat\Database\Packages\ApiKeys\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO ApiKeyDto:
...
final class ApiKeyDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'tenant_id', 'user_id' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'scopes' ];
    /** @var string[] */
    private const DATE_COLS   = [ 'last_used_at', 'expires_at', 'created_at', 'updated_at' ];
    /** @var string[] */
    private const BIN_COLS    = [ 'token_hash' ];
     ...
     * @return ApiKeyDto
     */
    public static function fromRow(array $row): ApiKeyDto
    {
        /** @var ApiKeyDto */
    ...
    public static function fromRowOrNull(?array $row): ?ApiKeyDto
    {
     ...
     */
    public static function toRow(ApiKeyDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(ApiKeyDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(ApiKeyDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(ApiKeyDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,ApiKeyDto>
     */
