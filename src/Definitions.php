...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'api_keys'; }
    public static function contractView(): string { return 'vw_api_keys'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'user_id', 'name', 'name_ci', 'token_hash', 'token_hash_key_version', 'scopes', 'status', 'last_used_at', 'expires_at', 'created_at', 'updated_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'token_hash' ], [ 'tenant_id', 'name_ci' ], [ 'tenant_id', 'id' ], [ 'id' ] ]; }

    /** @return string[] JSON columns for casts/operations */
    public static function jsonColumns(): array { return [ 'scopes' ]; }

    /** @return string[] List of numeric columns (generator heuristic; no runtime DB queries). */
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'user_id' ]; }
    ...
    public static function generatedColumns(): array { return [ 'name_ci' ]; }
    ...
    public static function piiColumns(): array { return [ 'name', 'token_hash' ]; }
