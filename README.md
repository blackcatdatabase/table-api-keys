...
> Lineage: 2 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 6 · Changelog: fresh
...
| Pkg folder | [packages/api-keys](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/api-keys) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package api-keys -Apply
